...
const IndividualPage: React.SFC = () => {
  ...
  return (
    <div className="IndividualPage">
      ...
      <ServiceInvolvement serviceInvolvementList={[{serviceInvolvementDetailsSummary: serviceInvolvementDetailsSummary, serviceDetailsContent: person}, {serviceInvolvementDetailsSummary: serviceInvolvementDetailsSummary2}]} />
    </div>
  );
}
