...
def api_spec_to_excel(spec, dest_filename):
    ...
    df = df[
        ["field", "title", "description", "type", "format", "pattern", "$ref", "items"]
    ]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Convert OpenAPI Schema to excel report"
    )
    parser.add_argument(
        "schema", metavar="<filename>", type=str, help="Filename of the input schema"
    )
    parser.add_argument(
        "output",
        metavar="<output>",
